...
* The predictor **like** is the most relevant of the candidates i.e. it's the one has that the most effect on the chance of p1 deciding to meet with p2 again.  The predictor **like**'s estimate range is the farthest from 1. To have an idea the effect of **like** is around duplicating the **oddratio**. 
    + To have a multiplier of negative effect comparable to **like** its C.I. would need to be around 0.5, so it would cut by half the **oddratio** the same way **like** doubles it. As we can see in the plot the range of all other predictors (**fun, attr, shar, sinc, prob, amb, intel, intel \cdot shar**) in terms of C.I. are far too close to 1 to compare to **like**.
