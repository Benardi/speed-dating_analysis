...
<br>
 ...
 $\large b1 = 0.9441278, \\ \large y = 1 \ (p1 \ wants \ to \ see \ p2 \ again ).$

<br>

The latter would render the following formula in terms of standard librarie output:

<br>

$$\large log(\frac{P(y = 1\ | \ x)}{1 - P(y = 1\ | \ x)}) =b_{0}+b_{1}x_{1}, \; \normalsize where: \ y = dec;\ x_{1}=like;$$
