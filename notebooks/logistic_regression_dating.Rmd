...
* $Rho-squared$ also known as $McFadden's \ pseudo \ R2$ can be interpreted like R2, but its values tend to be considerably lower than those of the R2 index. And values from 0.2-0.4 indicate (in McFadden's words) excellent model fit. Our $0.3230123$ therefore represents an excellent fit in terms of $McFadden's \ pseudo \ R2$.
