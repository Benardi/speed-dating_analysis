...
* In terms of relevance **attr** is the clear winner, i.e. it matters a lot more whether your participant 1 thinks you're attractive.
...
> At 95% of confidence we have evidence that the effect of intelligence on (like) is significant (C.I.) exclusively below 0.  
  
  * Is it relevant ?

> Among the significant predictors Intelligence has one of the less relevant effects, it still has it's value but you should be more worried that P1 thinks you're funny (fun) or attractive (attr). 

> To be honest there's a lot of uncertainty around Intelligence, as we have no evidence at 95% of confidence of difference in the magnitude of its effect and Sincerity's (sinc) or of its effect and Probability (prob): Intelligence C.I. encloses Sincerity's and Probability's. 
