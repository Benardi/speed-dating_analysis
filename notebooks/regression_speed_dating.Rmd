...
Our evaluation of the regressions can be divided as follow:
...
In this model we will include the main predictor variables (according to what we've seen in terms of correlation and some tweaking with the predictors that is not here). We'll also try to observe the effect of intelligence in sincerity.  
...
* All of the estimates (**attr, fun, intel, prob, shar, sinc, sinc * intel**) are significant, as none of them intersect 0.
* **attr, fun, intel, prob, shar,** and **sinc** have a positive effect, the model suggests that the higher these predictors the higher **like**.
* **sinc * intel** has a negative effect, the model suggests that the higher this predictors the lower **like**. Being smart and sincere seems to be a bad combination.
* In terms of relevance however **attr** is the clear winner, i.e. it matters a lot more whether your participant 1 thinks you're attractive.
    + **Intel** and **sinc** count among the less significant predictors of positive effect.
    + **sinc * intel** appears to not be relevant.
...
* The residuals appear to be somewhat randomly spread, however there's a tendency in them to form a parabole. 
